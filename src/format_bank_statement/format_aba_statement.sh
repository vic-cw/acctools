...
Usage:  $SCRIPT_NAME [-h] <input_file>
        ...
        Accepts only csv files generated by Advanced Bank of Asia.
...
"$_DIR_/"trim_aba_statement.sh "$FILE" | "$_DIR_/"utilities/convert_csv/convert_csv_from_semicolon_to_comma.sh
